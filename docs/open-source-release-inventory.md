...
| Slither reports | Present | `slither-report.md`, `reports/slither/slither-final.json`, `reports/slither/slither-final.txt` |
| HL7/FHIR examples | Present | `fixtures/fhir/*.json`, `docs/fhir-mapping.md`, `docs/fhir-limitations.md` |
